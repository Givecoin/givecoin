...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the Givecoin Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: Givecoin.conf)"),
